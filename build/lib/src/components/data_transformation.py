...
class DataTransformation:
    ...
    def get_transformation_data(self):
        #ogging.info("starting trasnformation data")
        try:
            ...
            3#logging.info("pipeline initiated")
            ...
            logging.info("model getting error")
    ...
    def initiate_Data_Transformation(self,train_path,test_path):
        try:
            ...
            logging.info("training and testing data uploaded")
